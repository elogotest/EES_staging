Feature: e Irsaliye FamilyName Kontrol

  Scenario Outline: e Irsaliye FamilyName Kontrol
    ...
    * Oluşturulan eIrsaliye Ubl'in FamilyName alanı Otomasyon ile aynı mı
    * Ana sekmeye geçilir
    * Kullanıcı işlemlerinden Çıkış seçilir

    Examples: 
      | kullaniciAdi | sifre  | alici_Adi     | malzeme_adi | aciklamasi | miktari | birimFiyat | not       | not1                   | unvan | tag            |
      | SAHIS6       | 123456 | otomasyontckn | Otomasyon   | Virgosol   |     400 |        100 | Otomasyon | Otomasyon Not Değiştir |       | DespatchAdvice |
