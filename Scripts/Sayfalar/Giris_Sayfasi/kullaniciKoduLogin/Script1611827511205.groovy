...
WebUI.click(findTestObject('Object Repository/Sayfalar/Giris_Sayfasi/Kullanici'))

WebUI.sendKeys(findTestObject('Sayfalar/Giris_Sayfasi/Firma_Kodu'), Firma)

WebUI.sendKeys(findTestObject('Sayfalar/Giris_Sayfasi/KullaniciKodu'), KullaniciAdi)
