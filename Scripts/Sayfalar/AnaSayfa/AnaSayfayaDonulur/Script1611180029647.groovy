...
//CustomKeywords.'Method.TextDegerineEsitElementeTiklaEquals'(findTestObject('Sayfalar/AnaSayfa/AnaSayfa'))
WebUI.click(findTestObject("Sayfalar/AnaSayfa/AnaSayfa"))
