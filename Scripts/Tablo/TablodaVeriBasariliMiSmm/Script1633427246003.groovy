...
sayac = 80
while(WebUI.verifyElementText(findTestObject("Tablo/DurumBilgisiSmm"), "Henüz Sonuçlanmadı", FailureHandling.OPTIONAL)) {
...
CustomKeywords.'Method.TextDegerineEsitElementVarMi'(findTestObject("Tablo/DurumBilgisiSmm"), "Başarılı")
